...
class Html2TextileConverterTest < ActiveSupport::TestCase
  ...
  def test_bold_with_new_lines_inside
    assert_textile ' *b o l d* ', "<b> b  o\nl d\n</b>"
  end

  def test_italic
    assert_textile ' _italic_ ', '<i>italic</i>'
  end

  def test_italic_with_spaces
    assert_textile ' _i t a l i c_ ', '<i>  i  t  a  l i c</i>'
  end
...
=begin
  def test_span_with_style
    assert_textile "I'm unaware of most soft drinks.\n\n",
...
'
  ...
  def test_div
    assert_textile "A single paragraph.Followed by another.",
                   "<div>A single paragraph.</div><div>Followed by another.</div>"
  end
...
test</span>"
  ...
  def test_font_tag
    assert_textile "Hello", '<font>Hello</font>'
  end

  def test_integration
    input = '<div dir="ltr">
    <font style="font-size:small;color:rgb(136,136,136)">
    <font color="#888888">Jocelyn Ban | Senior Creative Producer | </font>
	</font>
    <font color="#888888" style="font-size:small;color:rgb(136,136,136)">
    <a href="http://www.purpose.com/" style="color:rgb(17,85,204)" target="_blank">Purpose</a> | </font>
    <font style="font-size:small">
    <span style="border-collapse:collapse">
    <font color="#888888"> </font>
			<font color="#1155cc">646.465.4323</font>
    </span>
	</font>
    <span style="font-size:small;color:rgb(136,136,136)"></span>
	<span style="font-size:small;color:rgb(136,136,136)">|</span>
    <a value="+12125334114" href="mailto:jocelyn.ban@purpose.com" style="color:rgb(17,85,204);font-size:small" target="_blank">jocelyn.ban@purpose.com</a><br>
</div>'

    expected = "Jocelyn Ban | Senior Creative Producer |\n\"Purpose\":http://www.purpose.com/ |\n| 646.465.4323 | jocelyn.ban@purpose.com"

    assert_textile expected, input
  end
=end
  private

  def assert_textile(expected, actual)
    converter = TipitMailgunHandler::Html2TextileConverter.new(actual)
    assert_equal expected, converter.to_textile
  end
end
